...
export const metadata: Metadata = {
  title: {
    default: 'UMKM Delicious - Makanan Enak & Berkualitas',
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-4 mb-4 mb-lg-0">
                <h5 className="fw-bold mb-3">🍽️ UMKM Delicious</h5>
              ...
              <div className="col-lg-3 col-6 mb-4 mb-lg-0">
                ...
                <ul className="list-unstyled">
                  ...
                  <li className="mb-2">
                    <a 
                      href="mailto:info@umkmdelicious.com" 
                      className="text-light opacity-75 text-decoration-none hover-opacity-100"
                    >
                      ✉️ info@umkmdelicious.com
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div className="row align-items-center">
              <div className="col-md-6 text-center text-md-start">
                <p className="mb-0 text-light opacity-75">
                  &copy; {currentYear} UMKM Delicious. All rights reserved.
                </p>
              </div>
              <div className="col-md-6 text-center text-md-end">
                <p className="mb-0 text-light opacity-75">
                  Developed with ❤️ by <a href="/about" className="text-light text-decoration-none">Developer Team</a>
                </p>
              </div>
            </div>
          </div>
